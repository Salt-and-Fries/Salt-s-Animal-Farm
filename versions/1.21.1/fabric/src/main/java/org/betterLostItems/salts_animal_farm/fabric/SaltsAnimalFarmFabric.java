...
public final class SaltsAnimalFarmFabric implements ModInitializer {
    ...
    private static void registerPayloads() {
        PayloadTypeRegistry.playS2C().register(OpenConfigScreenPayload.TYPE, OpenConfigScreenPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(RenderDebugFarmDataPayload.TYPE, RenderDebugFarmDataPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(FarmDebugDataPayload.TYPE, FarmDebugDataPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(FarmAnimalStatePayload.TYPE, FarmAnimalStatePayload.CODEC);
    }
