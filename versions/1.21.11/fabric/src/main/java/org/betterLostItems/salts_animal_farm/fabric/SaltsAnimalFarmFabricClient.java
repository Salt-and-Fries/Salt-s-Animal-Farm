...
public final class SaltsAnimalFarmFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ClientPlayNetworking.registerGlobalReceiver(OpenConfigScreenPayload.TYPE, (payload, context) ->
                context.client().execute(AnimalFarmClientScreens::openConfigScreen));
